function aps
	if test -d /apollo/env/envImprovement
		...
		/apollo/bin/env -e envImprovement /apollo/bin/env -e WDETools /apollo/bin/env -e BarkCLI /apollo/bin/env -e GordianKnot /apollo/bin/env -e SDETools /usr/bin/fish
	end
end
