# Defined in /tmp/fish.mhy6MQ/skeleton.fish @ line 2
function skeleton
  if git remote | grep -q skeleton
    git remote get-url skeleton
  else
    test -e feathers-gen-specs.json; and git remote add skeleton ssh://git-codecommit.us-east-1.amazonaws.com/v1/repos/feathers-plus-api
    test -e aurelia_project; and git remote add skeleton ssh://git-codecommit.us-east-1.amazonaws.com/v1/repos/feathers-plus-web
  end
  git fetch skeleton
