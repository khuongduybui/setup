...
echo 'gdebi -n google-chrome-stable_current_amd64.deb' >> ~/bin/install-chrome.sh
...
echo 'gdebi -n skype-ubuntu-precise_4.3.0.37-1_i386.deb' >> ~/bin/install-skype.sh
...
echo 'gdebi -n viber.deb' >> ~/bin/install-viber.sh
...
echo 'gdebi -n teamviewer_linux.deb' >> ~/bin/install-teamviewer.sh
